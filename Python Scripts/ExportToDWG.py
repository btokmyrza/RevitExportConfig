...
def zipTheFolderWithSubfolders(output_zip_name, folder_to_zip):
    zipobj = zipfile.ZipFile(output_zip_name, 'w', zipfile.ZIP_DEFLATED)
...
for sheet in allSheets:
    ...
    saveName = file_name+"_"+sheet.SheetNumber +"-"+ sheet.Name
...
Output("Creating a zip archive....")
folder_to_zip = the_export_path
output_zip_name_path = the_export_path.rsplit("\\",1)[0]+"\\"+file_name+".zip"
zipTheFolderWithSubfolders(output_zip_name_path, folder_to_zip)
Output(" Done!")
